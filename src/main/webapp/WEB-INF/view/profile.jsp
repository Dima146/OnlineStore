        ...
        <div class="p-3 p-md-4 border rounded-3 my-sm-3">
            ...
            <table class="table">
                <tr>
                    ...
                    <td><h4><c:out value="${userInformation.userName}"/></h4>
                        <h4><c:out value="${userInformation.userSurname}"/></h4>
                        <h4><c:out value="${userInformation.userPatronymicName}"/></h4>
                    </td>
                </tr>
                <tr>
                    <td width="25px">
                    ...
                    <td><h4>+<c:out value="${userInformation.userPhoneNumber}"/></h4></td>
                </tr>
                <tr>
                    <td width="25px">
                        <h4 class="text-primary">
