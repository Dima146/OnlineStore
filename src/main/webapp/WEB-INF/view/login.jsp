  ...
  <div class="row justify-content-center">
    ...
    <div class="col-6 my-sm-3">
      ...
      <c:if test="${sessionScope.user == null}">
        ...
        <p class="text-muted"><fmt:message bundle="${loc}" key="language.noAccount"/>
          <a href="${pageContext.request.contextPath}/OnlineStore?command=registration"><fmt:message bundle="${loc}" key="language.logUp"/></a></p>
