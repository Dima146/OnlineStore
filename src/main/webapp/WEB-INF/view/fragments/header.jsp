...
<html>
<head>
    <jsp:include page="headerRefs.jsp"/>
    <title></title>
</head>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="font-size: 20px">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav mr-auto">
                    <a class="navbar-brand" style="font-size: 23px">
                        <fmt:message bundle="${info}" key="information.name"/>
                    </a>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/OnlineStore?command=main">
                        ...
                        <div class="dropdown-menu">
                            <c:forEach var="category" items="${categories}">
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/OnlineStore?command=catalog&categoryId=${category.id}">
                                    <c:out value="${category.productCategoryName}"/></a>
                            </c:forEach>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/OnlineStore?command=contacts">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="userDropdown">
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/OnlineStore?command=addProduct"><fmt:message bundle="${loc}" key="language.addProduct"/></a>
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/OnlineStore?command=viewOrders"><fmt:message bundle="${loc}" key="language.viewOrders"/></a>
                            </div>
                        </li>
                    </c:if>
                </ul>
                        ...
                        <c:when test="${sessionScope.language=='en'}">
                            ...
                            <li class="nav-item">
                                <a class="navbar-brand">
                                    <img src="<c:url value="/static/images/language_icons/EN.png"/>" width="30" height="20"/>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"
                                   href="${pageContext.request.contextPath}/OnlineStore?${pageContext.request.queryString}&language=ru">
                                    RU
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="navbar-brand">
                                    <img src="<c:url value="/static/images/language_icons/RU.png"/>" width="30" height="20"/>
                                </a>
                            </li>
                        </c:when>
                        ...
                        <c:when test="${sessionScope.user != null}">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="userDropdown">
                                    ...
                                    <a class="dropdown-item" href="${pageContext.request.contextPath}/OnlineStore?command=myOrders">
                                        <fmt:message bundle="${loc}" key="language.myOrders"/></a>
